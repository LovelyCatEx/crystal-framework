package com.lovelycatv.crystalframework.database.utils
 ...
 * then runs every registered [com.lovelycatv.crystalframework.database.interceptor.SqlStatementInterceptor] in ascending [com.lovelycatv.crystalframework.database.interceptor.SqlStatementInterceptor.order].
 * It holds no business rules of its own — soft-delete and `modified_time` maintenance live in
 * [com.lovelycatv.crystalframework.database.interceptor.SoftDeleteSqlInterceptor], and any module can contribute more interceptors as Spring beans.
 *
 * The interceptor chain is injected at startup (see the wiring in [com.lovelycatv.crystalframework.database.config.R2dbcSQLInterceptorConfig]) so
