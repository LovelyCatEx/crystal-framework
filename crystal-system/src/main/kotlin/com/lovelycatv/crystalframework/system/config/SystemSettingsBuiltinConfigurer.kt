    ...
    override fun configure(registry: SystemSettingsRegistry) {
        registry.settings(
            listOf(
                ...
                SystemSettingsConstants.Security.WebSocketAuthRateLimit.ENABLED,
                SystemSettingsConstants.Security.WebSocketAuthRateLimit.WINDOW_SECONDS,
                SystemSettingsConstants.Security.WebSocketAuthRateLimit.MAX_ATTEMPTS_PER_IP,
                SystemSettingsConstants.Security.WebSocketAuthRateLimit.MAX_ATTEMPTS_PER_ACCOUNT,
                SystemSettingsConstants.Security.WebSocketAuthRateLimit.LOCK_THRESHOLD,
                SystemSettingsConstants.Security.WebSocketAuthRateLimit.LOCK_BASE_SECONDS,
                SystemSettingsConstants.Security.WebSocketAuthRateLimit.LOCK_MAX_SECONDS,
