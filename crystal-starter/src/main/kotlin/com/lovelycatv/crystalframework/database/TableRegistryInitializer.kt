...
class TableRegistryInitializer(
    ...
    init {
        ...
        registry.register(TableConstants.TABLE_ECONOMY_CURRENCIES)
        registry.register(TableConstants.TABLE_ECONOMY_WALLETS)
        registry.register(TableConstants.TABLE_ECONOMY_TRANSACTIONS)
