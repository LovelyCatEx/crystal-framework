...
interface TenantRepository : BaseRepository<TenantEntity> {
    ...
    fun findAllByNameContainingIgnoreCase(keyword: String, pageable: Pageable): Flux<TenantEntity>

    fun countByNameContainingIgnoreCase(keyword: String): Mono<Long>

    fun findAllBy(pageable: Pageable): Flux<TenantEntity>
