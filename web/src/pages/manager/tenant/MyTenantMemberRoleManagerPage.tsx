    ...
    const columns = [
        {
            ...
            render: (_: unknown, row: TenantMemberVO) => (
                <Space orientation='vertical' size={0}>
                    <CopyableToolTip title={row.user?.nickname || t('pages.myTenantMemberRoleManager.columns.unknownUser')}>
                        <span className="text-xs font-mono">{row.user?.nickname || t('pages.myTenantMemberRoleManager.columns.unknownUser')}</span>
                    </CopyableToolTip>
