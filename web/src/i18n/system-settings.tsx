...
export function useSettingsKeyToTranslationMap(): Map<string, string> {
    ...
    const map = new Map<string, string>([
        ...
        ['security.webSocketAuthRateLimit.enabled', t('pages.systemSettingsManager.keys.security.webSocketAuthRateLimit.enabled')],
        ['security.webSocketAuthRateLimit.windowSeconds', t('pages.systemSettingsManager.keys.security.webSocketAuthRateLimit.windowSeconds')],
        ['security.webSocketAuthRateLimit.maxAttemptsPerIp', t('pages.systemSettingsManager.keys.security.webSocketAuthRateLimit.maxAttemptsPerIp')],
        ['security.webSocketAuthRateLimit.maxAttemptsPerAccount', t('pages.systemSettingsManager.keys.security.webSocketAuthRateLimit.maxAttemptsPerAccount')],
        ['security.webSocketAuthRateLimit.lockThreshold', t('pages.systemSettingsManager.keys.security.webSocketAuthRateLimit.lockThreshold')],
        ['security.webSocketAuthRateLimit.lockBaseSeconds', t('pages.systemSettingsManager.keys.security.webSocketAuthRateLimit.lockBaseSeconds')],
        ['security.webSocketAuthRateLimit.lockMaxSeconds', t('pages.systemSettingsManager.keys.security.webSocketAuthRateLimit.lockMaxSeconds')],
        ...
        ['module.message.systemPeerEnabled', t('pages.systemSettingsManager.keys.module.message.systemPeerEnabled')],
        ...
        ['module.webSocket.enabled', t('pages.systemSettingsManager.keys.module.webSocket.enabled')],
...
export function useSettingsGroupToTranslationMap(): Map<string, {label: string, icon?: ReactNode}> {
    ...
    const map = new Map<string, {label: string, icon?: ReactNode}>([
        ...
        ['security.webSocketAuthRateLimit', { label: t('pages.systemSettingsManager.groups.security.webSocketAuthRateLimit'), icon: <LockOutlined /> }],
        ...
        ['module.message', { label: t('pages.systemSettingsManager.groups.module.message'), icon: <AppstoreOutlined /> }],
        ['module.webSocket', { label: t('pages.systemSettingsManager.groups.module.webSocket'), icon: <ApiOutlined /> }],
