  ...
  pages: {
    ...
    permissionCatalog: {
      ...
      byName: {
        ...
        'system.permission': 'Manage user permissions menu',
        'system.role': 'Manage user roles menu',
        'system.user': 'Manage users menu',
        'system.user.role': 'Manage user-role assignments menu',
        'system.settings': 'Access system settings menu',
        'system.oauth.account': 'Manage OAuth accounts menu',
        'system.file.resource': 'Manage file resources menu',
        'system.storage.provider': 'Manage storage providers menu',
        'system.mail.template.category': 'Manage mail template categories menu',
        'system.mail.template.type': 'Manage mail template types menu',
        'system.mail.template': 'Manage mail templates menu',
        'system.tenant': 'Manage tenants menu',
        'system.tenant.tire.type': 'Manage tenant tire types menu',
        'system.tenant.tire.benefit.feature': 'Manage tenant tire benefit features menu',
        'system.tenant.tire.benefit.value': 'Manage tenant tire benefit values menu',
        'system.message.channel': 'Manage system message channels menu',
        'system.audit.log': 'Manage audit logs menu',
        'system.mail.send.log': 'Manage mail send logs menu',
        ...
        'x.approval.flow.instance': 'Manage approval flow instances menu',
        // System permissions - Components (system layer)
        'system.dashboard.business.statistics': 'Dashboard business statistics widget',
        'system.dashboard.system.metrics': 'Dashboard system metrics widget',
        'system.dashboard.tenant.joined': 'Dashboard joined tenants widget',
        'system.dashboard.announcements': 'Dashboard announcements widget',
        // System permissions - Actions (system layer: user permission / role / user)
        'system.permission.create': 'Create user permissions',
        'system.permission.read': 'Read user permissions',
        'system.permission.update': 'Update user permissions',
        'system.permission.delete': 'Delete user permissions',
        'system.role.create': 'Create user roles',
        'system.role.read': 'Read user roles',
        'system.role.update': 'Update user roles',
        'system.role.delete': 'Delete user roles',
        ...
        'system.user.role.update': 'Update user role assignments',
        // System settings / maintenance
        'system.settings.read': 'Read system settings',
        'system.settings.update': 'Update system settings',
        'system.settings.test.sendEmail': 'Send test email via system settings',
        'system.settings.test.sendMessage': 'Send test message via system settings',
        'system.maintenance.access': 'Access maintenance operations',
        'system.maintenance.update': 'Update maintenance operations',
        // OAuth account
        'system.oauth.account.create': 'Create OAuth accounts',
        'system.oauth.account.read': 'Read OAuth accounts',
        'system.oauth.account.update': 'Update OAuth accounts',
        'system.oauth.account.delete': 'Delete OAuth accounts',
        // File resource / storage
        'system.file.resource.create': 'Create file resources',
        'system.file.resource.read': 'Read file resources',
        'system.file.resource.update': 'Update file resources',
        'system.file.resource.delete': 'Delete file resources',
        'system.storage.provider.create': 'Create storage providers',
        'system.storage.provider.read': 'Read storage providers',
        'system.storage.provider.update': 'Update storage providers',
        'system.storage.provider.delete': 'Delete storage providers',
        // Mail template
        'system.mail.template.category.create': 'Create mail template categories',
        'system.mail.template.category.read': 'Read mail template categories',
        'system.mail.template.category.update': 'Update mail template categories',
        'system.mail.template.category.delete': 'Delete mail template categories',
        'system.mail.template.type.create': 'Create mail template types',
        'system.mail.template.type.read': 'Read mail template types',
        'system.mail.template.type.update': 'Update mail template types',
        'system.mail.template.type.delete': 'Delete mail template types',
        'system.mail.template.create': 'Create mail templates',
        ...
        'system.tenant.update': 'Update tenants',
        'system.tenant.delete': 'Delete tenants',
        'system.tenant.lifecycle.update': 'Update tenant ownership, tire, subscription window, status, or settings',
        // Tenant tire type / benefit (system layer)
        'system.tenant.tire.type.create': 'Create tenant tire types',
        'system.tenant.tire.type.read': 'Read tenant tire types',
        'system.tenant.tire.type.update': 'Update tenant tire types',
        'system.tenant.tire.type.delete': 'Delete tenant tire types',
        'system.tenant.tire.benefit.feature.create': 'Create tenant tire benefit features',
        'system.tenant.tire.benefit.feature.read': 'Read tenant tire benefit features',
        'system.tenant.tire.benefit.feature.update': 'Update tenant tire benefit features',
        'system.tenant.tire.benefit.feature.delete': 'Delete tenant tire benefit features',
        'system.tenant.tire.benefit.value.create': 'Create tenant tire benefit values',
        'system.tenant.tire.benefit.value.read': 'Read tenant tire benefit values',
        'system.tenant.tire.benefit.value.update': 'Update tenant tire benefit values',
        'system.tenant.tire.benefit.value.delete': 'Delete tenant tire benefit values',
        ...
        'x.message.channel.create': 'Create message channels in any scope',
        'x.message.channel.read': 'Read message channels in any scope',
        'x.message.channel.update': 'Update message channels in any scope',
        'x.message.channel.delete': 'Delete message channels in any scope',
        // Logs (system layer)
        'system.audit.log.create': 'Create audit logs',
        'system.audit.log.read': 'Read audit logs',
        'system.audit.log.update': 'Update audit logs',
        'system.audit.log.delete': 'Delete audit logs',
        'system.mail.send.log.read': 'Read mail send logs',
        'system.user.login.log.read': 'Read user login logs',
        ...
        'system.announcement.read': 'Read announcements',
        'system.announcement.update': 'Update announcements',
        'system.announcement.delete': 'Delete announcements',
        'system.announcement.list': 'List published announcements',
        // Approval flow definition (multi-layer)
        'x.approval.flow.definition.create': 'Create approval flow definitions in any scope',
        'x.approval.flow.definition.read': 'Read approval flow definitions in any scope',
        'x.approval.flow.definition.update': 'Update approval flow definitions in any scope',
        'x.approval.flow.definition.delete': 'Delete approval flow definitions in any scope',
        ...
        'system.approval.flow.instance.read': 'Read system-scope approval flow instances',
        ...
        'x.approval.flow.instance.read': 'Read approval flow instances in any scope',
        'tenant.approval.flow.instance.read': 'Read tenant-scope approval flow instances across tenants',
        // Dictionary type (multi-layer)
        'x.dict.type.create': 'Create dictionary types in any scope',
        'x.dict.type.read': 'Read dictionary types in any scope',
        'x.dict.type.update': 'Update dictionary types in any scope',
        'x.dict.type.delete': 'Delete dictionary types in any scope',
        ...
        'x.dict.item.create': 'Create dictionary items in any scope',
        'x.dict.item.read': 'Read dictionary items in any scope',
        'x.dict.item.update': 'Update dictionary items in any scope',
        'x.dict.item.delete': 'Delete dictionary items in any scope',
  ...
  components: {
    ...
    approvalFormDesigner: {
      ...
      property: {
        ...
        empty: 'Select a field on the left to edit its properties.',
        key: 'Key',
