...
export function useTenantRoleTableColumns(): EntityTableColumns<TenantRole> {
    const { t } = useTranslation();

    return [
        {
            title: t('components.columns.tenantRole.roleInfo'),
            dataIndex: "id",
            key: "id",
        ...
        {
            title: t('components.columns.tenantRole.description'),
        ...
        {
            title: t('components.columns.tenantRole.parentRole'),
            dataIndex: "parentId",
            key: "parentId",
            render: function (_: unknown, row: TenantRole): React.ReactNode | JSX.Element {
                if (row.parentId) {
