...
export function useMailTemplateTableColumns(): EntityTableColumns<MailTemplate> {
    const { t } = useTranslation();

    return [
        {
            title: t('components.columns.mailTemplate.name'),
            dataIndex: "name",
            key: "name",
        ...
        {
            title: t('components.columns.mailTemplate.type'),
            dataIndex: "typeId",
            key: "typeId",
            render: function (_: unknown, row: MailTemplate): React.ReactNode | JSX.Element {
        ...
        {
            title: t('components.columns.mailTemplate.title'),
            dataIndex: "title",
            key: "title",
            render: function (_: unknown, row: MailTemplate): React.ReactNode | JSX.Element {
                return (
        ...
        {
            title: t('components.columns.mailTemplate.description'),
        ...
        {
            title: t('components.columns.mailTemplate.content'),
            dataIndex: "content",
            key: "content",
            render: function (_: unknown, row: MailTemplate): React.ReactNode | JSX.Element {
                return (
