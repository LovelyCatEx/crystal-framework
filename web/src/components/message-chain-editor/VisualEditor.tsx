...
function ImageChip({attributes, element, children}: any) {
    ...
    const [imgLoading, setImgLoading] = useState(!isResource);
    ...
    return (
        <span {...attributes} contentEditable={false} className="inline-block mx-px align-middle">
            <span style={{
                ...
                {isResource ? (
                    <ImageResource fileEntityId={resourceId} height={40} width="auto" preview={false} style={{borderRadius: '4px'}}/>
                ) : imgError ? (
                    <span style={{
                        display: 'inline-flex',
                        alignItems: 'center',
                    ...
                    <>
                        ...
                        <img
                            ...
                            style={{
                                height: '40px',
                                borderRadius: '4px',
                                display: imgLoading ? 'none' : 'inline-block',
                            }}
