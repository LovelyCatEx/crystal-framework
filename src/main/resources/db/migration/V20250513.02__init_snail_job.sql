-- SnailJob tables initialization
-- Migrated from docker/postgres/init/snail_job_postgres.sql
...
INSERT INTO sj_namespace (id, name, unique_id, create_dt, update_dt, deleted)
VALUES (2, 'CrystalFramework', 'CRh3mSYLf46rzyr7IU01jYfDNSLKre6H', now(), now(), 0);
...
INSERT INTO sj_group_config (id, namespace_id, group_name, description, token, group_status, version, group_partition, id_generator_mode, init_scene)
VALUES (1, 'CRh3mSYLf46rzyr7IU01jYfDNSLKre6H', 'CrystalFramework', '', 'SJ_Wyz3dmsdbDOkDujOTSSoBjGQP1BMsVnj', 1, 1, 0, 2, 1);
