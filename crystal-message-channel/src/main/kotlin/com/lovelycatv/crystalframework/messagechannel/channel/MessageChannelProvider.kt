...
/**
 * Channel-specific sender. One bean per supported channel; the [com.lovelycatv.crystalframework
 * .messagechannel.service.MessageChannelService] routes to the right provider by [channelType].
 *
